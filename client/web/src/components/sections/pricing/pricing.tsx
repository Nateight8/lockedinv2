...
export function Pricing() {
  const pricing = [
    {
      title: "Free",
      subtitle: "Personal Trader",
      price: "$0",
      billed: "forever",
      cta: "Get Started",
      popular: false,
      listItems: [
        "up to 6 trading accounts",
        "Manual trade entry (unlimited)",
    ...
    {
      title: "Basic",
      subtitle: "Serious Trader",
      price: "$19/month",
      billed: "per month",
      annualPrice: "$15/month billed annually",
      cta: "Start 7-Day Trial",
      popular: true,
      listItems: [
        "Everything in Free, plus:",
        "6+ trading accounts",
        "EA auto-sync (real-time)",
        "Unlimited trade history",
        "Session performance analysis",
        "Currency pair breakdown",
        "Spread & commission tracking",
        "Screenshot uploads (5 per trade)",
    ...
    {
      title: "Pro",
      subtitle: "Prop Trader",
      price: "$39/month",
      billed: "per month",
      annualPrice: "$29/month billed annually",
      cta: "Start 7-Day Trial",
      popular: false,
      badge: "Most Value",
      listItems: [
  ...
  return (
    <Section className="xl:max-w-7xl" id="pricing">
      <Heading tag="pricing" subtitle="Check out our different pricing plans.">
    ...
    >
      ...
      <footer className="relative flex w-full items-center self-stretch p-8 pt-0">
        ...
        {item.popular ? (
          <Button
            variant="default"
            className="z-10 w-full bg-primary text-primary-foreground"
            size="lg"
          >
            yes
          </Button>
        ) : (
          <Button variant="secondary" className="z-10 w-full" size="lg">
            Get started
          </Button>
        )}
      </footer>
